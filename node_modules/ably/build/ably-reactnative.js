    ...
    _publish(messages, callback) {
        ...
        switch (state) {
            ...
            default: {
                ...
                msg.action = protocolmessagecommon_1.actions.MESSAGE;
...
class PendingMessage {
    constructor(message, callback) {
        ...
        this.ackRequired = action == protocolmessagecommon_1.actions.MESSAGE || action == protocolmessagecommon_1.actions.PRESENCE;
    }
}
...
function fromDeserialized(deserialized, presenceMessagePlugin) {
    ...
    return Object.assign(new ProtocolMessage(), Object.assign(Object.assign({}, deserialized), { presence, messages, error }));
}
...
function fromDeserializedIncludingDependencies(deserialized) {
    return fromDeserialized(deserialized, { PresenceMessage: presencemessage_1.default, WirePresenceMessage: presencemessage_1.WirePresenceMessage });
}
...
class ProtocolMessage {
    ...
    getMode() {
        return this.flags && this.flags & protocolmessagecommon_1.flags.MODE_ALL;
    }
...
exports.flags.MODE_ALL = exports.flags.PRESENCE | exports.flags.PUBLISH | exports.flags.SUBSCRIBE | exports.flags.PRESENCE_SUBSCRIBE;
